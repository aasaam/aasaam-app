...
RUN export DEBIAN_FRONTEND=noninteractive ; \
  ...
  && rm .git .github test -rf && find . -type f ! -name '*.css' ! -name '*.gif' ! -name '*.ico' ! -name '*.txt' ! -name 'theme.json' ! -name '*.js' ! -name '*.php' ! -name '*.phtml' ! -name '*.png' ! -name '*.html' ! -name '*.twig' ! -name '*.sql' -delete \
  && rm config.sample.inc.php \
  && echo '' | base64 --decode > config.inc.php \
